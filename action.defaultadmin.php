...
echo $this->SetTabHeader('notifications',$this->Lang('notifications'), ('notifications' == $tab)?true:false);
...
include(dirname(__FILE__).'/tabcontent.admin_notifications.php'); 
echo $this->EndTab();

echo $this->StartTab('options', $params);   
include(dirname(__FILE__).'/tabcontent.admin_options.php'); 
echo $this->EndTab();
